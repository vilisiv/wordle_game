...
import 'package:wordle_game/core/const/data/enums/keyboard_keys.dart';
import 'package:wordle_game/core/const/data/enums/letter.dart';
...
class KeyboardKey extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<HomeCubit, HomeState>(buildWhen: (_, currentState) {
